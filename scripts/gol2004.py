...
PinModel("ynk-gol2004-v2", "train/gol2004/ynk.traineddata", "ynk").pin()
# conv = ImagesToBoxes(
#     "/app/data/gol2004-pages-clean-2",
...
ImagesToTexts("/app/data/gol2004-pages-clean-2", "/app/data/gol2004-texts-2", extension="jpg", lang="ynk").convert()
