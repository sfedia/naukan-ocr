...
for picture in pics:
    ...
    convert "{output_folder}/{picture}" -crop 900x1100+440+0 "{output_folder}/ynk.nenl1990.exp{str(i)}.jpg";
    convert "{output_folder}/{picture}" -crop 900x1100+1400+0 "{output_folder}/ynk.nenl1990.exp{str(i + 1)}.jpg";
