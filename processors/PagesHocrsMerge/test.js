...
var hocrConv = require('/app/src/hocr2pdf/index.js')
var sharp = require('sharp')

console.log(__dirname)
var sample = __dirname + '/page-040.hocr'
var output = __dirname + '/page-040.pdf'
var imageFile = __dirname + '/page-040.jpg'
...
sharp(fs.readFileSync(imageFile))
  ...
  .toBuffer(function(err, data, info) {
    ...
    for (var x = 0; x < words.length; x++) {
      ...
      pdfFile.font(`${__dirname}/roboto.ttf`)
